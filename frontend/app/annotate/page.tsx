...
export default function AnnotateIndex() {
  return (
    <AppShell breadcrumbs={[{ label: "Annotate" }]}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "80vh", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "var(--color-text-secondary)", maxWidth: 400, marginBottom: 32 }}>
          The annotation workspace requires a specific image. Please select a project or dataset, then click on an image to start annotating.
        </p>
